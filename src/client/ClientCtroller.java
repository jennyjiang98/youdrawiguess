...
//                          JOptionPane.showMessageDialog(null, "你猜对了！");  
                            ui.jta.append("对方猜对了"+"\r\n");  
                            socket.close();
                            int res=JOptionPane.showConfirmDialog(null, "是否再来一轮？", "你画的太好了！", JOptionPane.YES_NO_OPTION);
...
//                  System.out.println("猜客户端接收的消息为:"+info);  
                    ...
                    //如果是自己发送的猜的消息  
                        ...
                        if("yes".equals(info2)){  
                            ...
                            socket.close();
                            int res=JOptionPane.showConfirmDialog(null, "是否再来一轮？", "你太强了！", JOptionPane.YES_NO_OPTION);
                            if(res==JOptionPane.YES_OPTION){ 
